...
namespace PortfolioWebSite.Areas.Manage.Controllers
{
    ...
    public class CvController : Controller
    {
        ...
        public async Task<IActionResult> Create(IFormFile file)
        {
            ...
            var filename = Path.GetFileNameWithoutExtension(file.FileName) + "_" + DateTime.Now.ToString("yyyyMMddHHmmssfff") + Path.GetExtension(file.FileName);
        ...
        public async Task<IActionResult> Update(int id , IFormFile file)
        {
            ...
            var filename = Path.GetFileNameWithoutExtension(file.FileName) + "_" + DateTime.Now.ToString("yyyyMMddHHmmssfff") + fileExtension;
            var filePath = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot/assets/cv", filename);
            ...
            var oldfilePath = Path.Combine(Directory.GetCurrentDirectory(),"wwwroot/assets/cv",cv.FileName);
